...
#def main(frame):
    ...
    imgOriginalScene  = cv2.imread("detected.jpg")               # open image
    #imgOriginalScene = frame
    #imgOriginalScene = imgOriginalScene[0:900, 0:900]
    #imgOriginalScene = cv2.resize(imgOriginalScene, (0, 0), fx = 2, fy = 2)
    #print(pytesseract.image_to_string(imgOriginalScene))
    #cv2.waitKey(0)
    ...
    if len(listOfPossiblePlates) == 0:                          # if no plates were found
        ...
        #tesseractImg = cv2.resize(licPlate.imgThresh, (licPlate.imgThresh.shape[1] * 2, licPlate.imgThresh.shape[0] * 2))
        #cv2.imshow("Tesseract Image", tesseractImg)
...
#----------------------------------------------------------------------------------------------
        ...
        if len(tesseractEnlarged3) > 8:
            ...
            tesseractEnlarged3 = tesseractEnlarged3[:8]
    
        #print("Enlarged output (1.6): " + str(tesseractEnlarged3) + "\n")
        ...
        #print("Enlarged output (2.0): " + str(tesseractEnlarged4) + "\n")

        #if (len(licPlate.strChars) < 6 and len(tesseract) < 6) or (len(licPlate.strChars) > 8 and len(tesseract) > 8):
            #return
        ...
        #cv2.imwrite("Threshold Image.jpg", licPlate.imgThresh)
        #cv2.imwrite("Plate Image.jpg", licPlate.imgPlate)
        ...
        #print("Final output: " + str(finalResult) + "\n")

        #writeLicensePlateCharsOnImage(imgOriginalScene, licPlate)           # write license plate text on the image
        
        #imgOriginalSmall = cv2.resize(imgOriginalScene, (0, 0), fx = 0.25, fy = 0.25)
        #cv2.imshow("imgOriginalScene", imgOriginalScene)                # re-show scene image

        #cv2.imwrite("Recognized Plate.jpg", imgOriginalScene)           # write image out to file
